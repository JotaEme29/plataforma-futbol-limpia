...
const LoginForm = () => {
  ...
  return (
    <div className="w-full text-gray-900 dark:text-gray-100">
      ...
      <p className="text-center text-gray-500 dark:text-gray-400 mb-6">Accede a tu club</p>
...
function Home() {
  ...
  return (
    <div
      className="flex min-h-screen w-full items-center justify-center p-4 transition-colors duration-300 relative overflow-hidden"
